...
const Services = () => {
    return (
        <div className='flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services px-8'>
            ...
            <div className='flex-1 flex flex-col justify-start items-center'>
                ...
                <ServiceCard
                    ...
                    subtitle='We provide the best exchange rates in comparison to the industry.'
                ...
                <ServiceCard
                    ...
                    subtitle='Fastest Transaction speed in comparison to the industry.'
